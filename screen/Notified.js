...
export default class Notified extends React.Component{
    constructor(props){
        super(props);
    }
    state={
...
<Container style={styles.Container}>
    <Text style={{color:'white',fontSize:30,fontWeight:'bold'}}>Get Notified</Text>
<Ionicons name="ios-notifications-outline" size={150} color="red" />
        <Text style={{color:'white',fontSize:20,fontStyle:"italic",textAlign:'center'}}>Recieve Notifications when you get messages and Matches</Text>

...
export default class Chat_privately extends React.Component{
    constructor(props){
        super(props);
    }
    state={
...
<Container style={styles.Container}>
    <Text style={{color:'white',fontSize:30,fontWeight:'bold'}}> Private Messages </Text>
    <MaterialCommunityIcons name="message-text-outline" size={150} color="red" />
        <Text style={{color:'white',fontSize:20,fontStyle:"italic",textAlign:'center'}}>Chat privately with people you match</Text>      
